...
module.exports = {
	...
	AUDIO_DATA: process.env.AUDIO_DATA || "RONYBOT;MRRONY;https://url.aswinsparky.qzz.io/sparky.jpg",
	AUTO_STATUS_VIEW: toBool(process.env.AUTO_STATUS_VIEW || "true"),
	BOT_INFO: process.env.BOT_INFO || "RONYBOY;MRRONY;https://url.aswinsparky.qzz.io/sparky.jpg",
